        ...
        <table>
            ...
            <form method="post" enctype="multipart/form-data" action="../business/categoriaAction.php">
                <tr>
                    ...
                    <td><input required type="text" name="nombre" id="nombre" pattern="^[A-Za-z]+$" title="Solo se permiten letras y espacios"/></td>
                    <td><input required type="text" name="descripcion" id="descripcion" pattern="^[A-Za-z]+$" title="Solo se permiten letras y espacios"/></td>
